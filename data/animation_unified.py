...
kpath = 'D:/Project/PyKinect2-master/Kproject/data/Motion and Kinect/Unified_KData'
Mpath = 'D:/Project/PyKinect2-master/Kproject/data/Motion and Kinect/Unified_MData'

for Kfile,Mfile in zip(glob.glob(os.path.join(kpath, '*.pkl') ),glob.glob(os.path.join(Mpath, '*.pkl') )):
    print Kfile
    print Mfile
