...
#
#
kdata_all  = cPickle.load(file('F:/AllData_0327/Motion and Kinect raw data/3D_kinect_joint/ex4/Andy_data201612151615_raw3D_ex4.pkl'))



mdata_all  = cPickle.load(file('F:/AllData_0327/Motion and Kinect raw data/Not_unified_Mdata/ex4/Andy_2016-12-15 04.15.27 PM_ex4_FPS30_motion.pkl'))
...
for frame_no in xrange(100,101):#min(kNUM_FRAMES,NUM_FRAMES)):
    plt.cla()
...
#        
    ...
    ax.scatter(mzs, mxs, mys,c = 'green',s = 30,alpha=.4,label='M')
