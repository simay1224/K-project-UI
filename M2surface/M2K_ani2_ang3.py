# -*- coding: utf-8 -*-
"""
Created on Mon Jul 17 03:54:25 2017
...
name    = 'Angela_data20170306090339_ex3'
exeno   = name.split('_')[-1]
vid_src  = 'F:/avi/'+name+'.avi'
...
#raw kinect data
Kinfile   =  src_path + 'Motion and Kinect raw data/20170306/pkl/Angela/'+name.replace('data2017','data')+'.pkl'
#not unified Motion camera data
Minfile   = src_path + 'Motion and Kinect raw data/raw_MData/'+exeno+'/Angela_2017-03-06 09.03.51 AM_ex3_FPS30_motion.pkl' 
#raw data
Mraw      = src_path + 'Motion and Kinect raw data/Not_unified_Mdata/'+exeno+'/Angela_2017-03-06 09.03.51 AM_ex3_FPS30_motion.pkl' 
Kraw      = src_path + 'Motion and Kinect raw data/3D_kinect_joint/'+exeno+'/'+name.replace(exeno,'raw3D_'+exeno)+'.pkl' 
# filtered data
Mpinfile  = src_path +'GPRresult/'+exeno+'/K2M_800/'+name.replace(exeno,'unified_'+exeno)+'.h5'
...
cv2.circle(img ,(int(Ccord[5][0,idx]),int(Ccord[5][1,idx])+20), 5, (0,0,255), -1)    
...
cv2.line(img,(int(Ccord[4][0,idx]),int(Ccord[4][1,idx])),(int(Ccord[5][0,idx]) ,int(Ccord[5][1,idx])+20) ,(0,0,255),3) 
cv2.line(img,(int(Ccord[5][0,idx]),int(Ccord[5][1,idx])+20),(int(Ccord[6][0,idx]) ,int(Ccord[6][1,idx])) ,(0,0,255),3)
