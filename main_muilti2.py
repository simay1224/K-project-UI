...
#        self._frame_surface = pygame.Surface((self._kinect.color_frame_desc.Width, self._kinect.color_frame_desc.Height), 0, 32)
    ...
    def videoplay(self, change=False):    
        # Video
        if change:
            self.movie.stop()
        pygame.mixer.quit()
        # self.movie = pygame.movie.Movie(r'ex'+str(self.exeno)+'.mpg')
        self.movie = pygame.movie.Movie(r'ex2.mpg')
...
#                        self.cimgs = self.imgs.create_group('cimgs')
                ...
                if press[102] == 1: # use 'f' to open/close video recording                        
