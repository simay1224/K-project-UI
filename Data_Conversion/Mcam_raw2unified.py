...
'''
convert raw MOCAP data(.csv) to Unified data.
1. Mocap raw data -> Mocam(Kinect-like) data
2. Mocam(Kinect-like) data -> Unified data (dtype:dict) 
...
src_path = 'D:/AllData_0327(0220)/AllData_0327/Motion and Kinect raw data/20180327/MoCam/30/'
...
# =================== extract from csv, rotate the body, save as dict file  ================= 
# step 1: Mocap raw data -> Mocam(Kinect-like) data 
...
#======================== unified the Mocam(Kinect-like) data ========================
# step 2: Mocam(Kinect-like) data -> Unified data (dtype:dict)     
for i in range(1,8):
    exeno = 'ex'+repr(i)
    uni_src_path = dst_path+exeno+'/'
    uni_dst_path30  = 'D:/AllData_0327(0220)/AllData_0327/unified data/Unified_MData/'
