...
from .analysis.dtw2 import Dynamic_time_warping
from .analysis.breathstus import Breath_status
from .analysis.handstatus import Hand_status
from .analysis.shld_state import Shld_state
from .analysis.clasp_spread import Clasp_spread
from .analysis.horzp import Horzp
from .analysis.pushdp import Pushdp
from .analysis.swing import Swing
        ...
        if exeno == 1:
            ...
            if self.horzp.do:
                ...
                if self.horzp.cnt > 4:
                    ...
                    if stus == None and self.repcnt < 4 :
                        ...
                        evalinst.blit_text(surface, exeno, kp, 'Open your arms to T-pose', 2, color=self.c_normal)
            ...
            if self.swing.cnt/2 > 4:
                ...
                if self.swing.bend_left:
                    ...
                    evalinst.blit_text(surface, exeno, kp, 'Bend to your right', 2, color=self.c_normal)
