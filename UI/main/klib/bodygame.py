            ...
            if self._bodies is not None:
                ...
                if (closest_ID != -1):
                    ...
                    if not self.dtw._done:
                        ...
                        self.io.typetext(self.bk_frame_surface, 'Exercise '+str(self.exeno)+' is done', (20, self.bk_frame_surface.get_height()*0.75),(255, 0, 0), fontsize=100)
...
#                self.cimgs.create_dataset('img_'+repr(self.kp.fno).zfill(4), data = frame)
            ...
            self.io.typetext(self.bk_frame_surface, 'Exercise '+str(self.exeno), (int(self.bk_frame_surface.get_width()*0.75), 20), (0, 255, 0), fontsize=40)
            ...
            if (float(self._screen.get_height())/self._screen.get_width()) > self.h_to_w:
                ...
                if self._screen.get_width() != self.default_w:
                    ...
                    self.default_w = self._screen.get_width()
                    self.default_h = target_height
            surface_to_draw = pygame.transform.scale(self._frame_surface, (int(self.default_w*0.75), int(self.default_h*0.75)))
            # print self._screen.get_width()
            # print self.bk_frame_surface.get_height()
            # print int(self.default_w*0.75)
